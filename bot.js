...
client.on('message', msg => {  //WESO#0001
    if (msg.content === 'محمد') {  //WESO#0001
      msg.reply('** :wink: عيون محمد   :sparkling_heart:**');  //WESO#0001
    }
  });

client.on('message', msg => {  //WESO#0001
    if (msg.content === 'زين') {  //WESO#0001
      msg.reply('**زين سحبة**');  //WESO#0001
    }
  });


client.on('message', msg => {  //WESO#0001
    if (msg.content === 'محمود') {  //WESO#0001
      msg.reply('**اكثر واحد سحبة لا تناديه**');  //WESO#0001
    }
  });
  ...
  client.on('message', msg => {  //WESO#0001
    if (msg.content === '.') {  //WESO#0001
      msg.reply('**يلبه يلي يحط نقطة**');  //WESO#0001
    }
  });
...
client.on("message", message => {
    ...
    .setFooter('Requested by '+message.author.username, message.author.avatarURL)
      ...
      if( !msg.startsWith( prefix + 'تفضل' ) ) return;
...
『-تفضل all rolename ====> لأعطاء رتبة للجميع
『-تفضل humans rolename ====> لأعطاء رتبة للاشخاص فقط
『-افضلل ====> لأعطاء رتبة لجميع البوتات
